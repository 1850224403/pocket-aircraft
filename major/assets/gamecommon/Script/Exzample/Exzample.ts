...
import { PassMoreGameManager } from "../MoreGame/PassMoreGameManager";
...
export class Exzample extends cc.Component {
    ...
    start() {
        ...
        PassMoreGameManager.showPassMoreGame();
    ...
    private clickMoreGame(): void {
        // PassMoreGameManager.showPassPartMoreGame(1, null);
        MoreGameManager.showPartMoreGame(null);
        // MoreGameManager.showBackHomeMoreGame(null, null);
        // MoreGameManager.showBoyMoreGame(null);
        // UserData.data.gender = 1;
    }

    private clickChangeGender(): void {
        UserData.data.gender = 1;
    }
}
